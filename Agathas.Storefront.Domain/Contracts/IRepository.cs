...
namespace Agathas.Storefront.Domain.Contracts
{
        ...
        where TEntity : class, IAggregateRoot,IObjectWithChangeTracker
    {
        ...
        /// <param name="ascending">Specify if order is ascending</param>
        /// <returns>List of selected elements</returns>
        IEnumerable<TEntity> GetFilteredElements<TS>(Expression<Func<TEntity, bool>> filter, int pageIndex, int pageCount,
                                                    Expression<Func<TEntity, TS>> orderByExpression, bool ascending);
        ...
        /// <returns>List of selected elements</returns>
        IEnumerable<TEntity> GetPagedElements<TS>(int pageIndex, int pageCount,
                                                  Expression<Func<TEntity, TS>> orderByExpression,
