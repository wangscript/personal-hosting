...
namespace Agathas.Storefront.Domain.MainModule.Entities
{
    ...
    public partial class Color: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int ColorId
        {
            ...
            set
            {
                if (_colorId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'ColorId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _colorId = value;
