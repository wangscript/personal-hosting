...
namespace Agathas.Storefront.Domain.MainModule.Entities
{
    ...
    public partial class Size: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int SizeId
        {
            ...
            set
            {
                if (_sizeId != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'SizeId' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _sizeId = value;
        ...
        private void FixupProducts(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Size, this))
                    {
                        item.Size = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
